...
def train_cmodgpt2_and_augment(model,tokenizer,train_df,val_df,output='PosGpt2_eda',file_name='augment.tsv',seed = 1234,max_seq_length = 64,sample_num=6,num_train_epochs=8):
